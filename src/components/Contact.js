...
const Contact = () => {
  return (
    <div className="max-w-[80rem] m-auto px-12 text-primary py-34">
      <h1 className="font-clash-display text-main-text-light dark:text-hover font-semibold text-7xl md:text-9xl text-center pb-10">
        <span className="uppercase">let&apos;s </span>get <br /> in{" "}
        <span className="uppercase italic underline">touch</span>
      </h1>
      <div className="flex flex-row pb-10">
        <div className="md:flex-1"></div>
        <div className="md:flex-1 text-main-text-light dark:text-main-text-dark">
          {" "}
